...
const DronePage = () => {
  ...
  return (
    <div className="w-screen h-[90vh] bg-[#121212] flex flex-col items-center">
      ...
      <div className='flex w-3/4 h-full pt-4 gap-8'>
        <div className='w-1/3 flex flex-col gap-12 pt-4'>
          <p className="text-white text-4xl font-sans font-semibold text-center">{drone.id}</p>
          <img className='' loading='lazy' src="https://imgs.search.brave.com/Ot0DR7B44OUBcKNK9s5jTNUQO1KaWiCvXwRLpdSJ52o/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly9tZWRp/YS5pc3RvY2twaG90/by5jb20vaWQvNDky/NjgzODY1L3Bob3Rv/L2Ryb25lLXdoaXRl/LWNsb3VkeS1kdXNr/LXNreS5qcGc_cz02/MTJ4NjEyJnc9MCZr/PTIwJmM9a3p6Vl9m/dTlvbkJBcmhNS2JF/NHN4UmU0SzIyZnBX/Sy1iZDEtUE1pSjYw/OD0" />
        </div>
        <div className='w-2/3 px-4 flex flex-col gap-2'>
          ...
          <ul className='list-disc px-8'>
            ...
            <p className='text-slate-300 text-lg font-medium mt-4'>Maintainence Logs :</p>
